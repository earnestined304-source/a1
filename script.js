// ==========================================================================
// WisdomSchool - Modern Academic Atelier Script
// Clean, interactive, high-performance behaviors
// ==========================================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedTheme = localStorage.getItem('wisdomschool_theme') || 'light';
    ...
    if (themeToggle) {
        themeToggle.addEventListener('click', () => {
            ...
            localStorage.setItem('wisdomschool_theme', newTheme);
    ...
    // 4. Interactive Cohort Progression Tabs
    const cohortBtns = document.querySelectorAll('.cohort-tab-btn');
    const cohortPanes = document.querySelectorAll('.cohort-pane');

    if (cohortBtns.length > 0 && cohortPanes.length > 0) {
        cohortBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                const targetId = btn.getAttribute('data-target');
                
                cohortBtns.forEach(b => b.classList.remove('active'));
                cohortPanes.forEach(p => p.classList.remove('active'));
